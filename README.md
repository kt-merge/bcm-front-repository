...
> 익명 기반 중고 경매 거래 플랫폼 **Blind Chicken Market**의 **회원용 프론트엔드 웹 애플리케이션**입니다. <br />
> 사용자는 익명으로 상품을 등록하고, 경매에 참여하거나 즉시 구매할 수 있습니다.

### 📍 프로젝트 개요
- 개발 기간: 2025.10.31 ~ 2026.01.02
- 팀 구성: Frontend 2명(회원용, 관리자용), Backend 3명
- 역할: 회원용 프론트엔드 개발 99% 담당
- 주요 목표:
  - 안정적인 인증 구조 설계
  - 실시간 통신을 활용한 사용자 경험 개선
